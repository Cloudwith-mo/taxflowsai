...
resource "aws_appautoscaling_policy" "dynamodb_table_read_policy" {
  name               = "${var.project_name}-${var.environment}-dynamodb-read-scaling-policy"
...
resource "aws_appautoscaling_policy" "dynamodb_table_write_policy" {
  name               = "${var.project_name}-${var.environment}-dynamodb-write-scaling-policy"
  policy_type        = "TargetTrackingScaling"
...
# X-Ray Tracing
resource "aws_xray_sampling_rule" "taxflowsai" {
